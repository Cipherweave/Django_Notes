...
class Product(models.Model):  # these fields are all in https://docs.djangoproject.com/en/5.0/ref/models/fields/ 
    ...
    unit_price = models.DecimalField(max_digits=6, decimal_places=2)  # decimal(6,2)  is like 9999.99
    ...
    promotions = models.ManyToManyField(Promotion, related_name='product')  # many to many relationship with the promotion table
...
class Cart(models.Model):
    ...
    customer = models.OneToOneField(Customer, on_delete=models.CASCADE)  # one to one relationship with the customer table
